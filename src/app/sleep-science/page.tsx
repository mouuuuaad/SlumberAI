      ...
      <main className="flex-grow container mx-auto px-4 py-10 md:py-16">
        <div className="text-center mb-10 md:mb-12">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-primary mb-3 flex items-center justify-center gap-3">
            ...
            Sleep Science Explorer
          </h1>
          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
            Dive into the fascinating science behind sleep. Understand your body's needs and learn how to optimize your rest for better health and well-being.
          </p>
        </div>
        ...
        <div className="space-y-8">
          {articles.map((article, index) => (
            <ScienceArticle
              ...
              defaultOpen={index === 0} // Open the first article by default
            />
          ))}
        </div>
      </main>
